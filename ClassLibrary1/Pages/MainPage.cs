...
namespace ClassLibrary1.Pages
{
    public class MainPage : BasePage
    {
        ...
        [FindsBy(How = How.XPath, Using = "//span[contains(@class, 'cta-button__text')] [contains(text(),'CONTACT US')]")]
        ...
        [FindsBy(How = How.XPath, Using = "//a[contains(@href,'https://www.infongen.com/')]")]
        private IWebElement infongenButton;
       
        //We are in button, 4 scenario
        [FindsBy(How = How.XPath, Using = "//a[contains(@class,'footer__social-link')][contains(@href, 'https://www.facebook.com/EPAM.Globa')]")]
        private IWebElement facebookButton;

        //Our work button, 5 scenario
        [FindsBy(How = How.XPath, Using = "//span[contains(text(),'Learn more')]")]
        ...
        public void ClickButton(string button)
        {
            ...
            new WebDriverWait(driver, TimeSpan.FromSeconds(10)).Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(but));
            but.Click();
        }
